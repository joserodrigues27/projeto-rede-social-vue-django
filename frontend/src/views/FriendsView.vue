<template>
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-2 space-y-4">
            ...
            >
                <h2 class="mb-4 text-xl text-center">Solicitações de amizade</h2>
                ...
                >
                    <img src="https://i.pravatar.cc/100?img=12" class="mb-6 rounded-full">
                    ...
                    <div class="mt-6 flex space-x-8 justify-around">
                        <p class="text-xs text-gray-500">{{ friendshipRequest.created_by.friends_count }} amigos</p>
                        <p class="text-xs text-gray-500">130 postagens</p>
                    </div>

                    <div class="mt-6 space-x-4">
                        <button class="inline-block py-4 px-6 bg-blue-600 text-white rounded-lg" @click="handleRequest('accepted', friendshipRequest.created_by.id)">Aceitar</button>
                        <button class="inline-block py-4 px-6 bg-red-600 text-white rounded-lg" @click="handleRequest('rejected', friendshipRequest.created_by.id)">Rejeitar</button>
                    </div>
                </div>
